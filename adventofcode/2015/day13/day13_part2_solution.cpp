...
int main()
{
    ...
    string me = "-----";
    assert(!allPeople.contains(me));
    allPeople.insert(me);
    for (const auto& otherPerson : allPeople)
    {
        happinessChangeWithNeighbour[me][otherPerson] = 0;
        happinessChangeWithNeighbour[otherPerson][me] = 0;
    }
