...
string getNextPassword(const string& origPassword)
{
    string password = origPassword;
    static const string forbiddenStrings[] = {"i", "o", "l"};
...
int main()
{
    ...
    std::cout << "password: " << getNextPassword(getNextPassword(password)) << std::endl;
