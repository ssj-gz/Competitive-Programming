...
int main()
{
    ...
    int numRoomsWithDist1000OrMore = 0;
    for (const auto [coord, shortestPathNumDoors] : shortestPathTo)
    {
        if (shortestPathNumDoors >= 1000)
            numRoomsWithDist1000OrMore++;
    }
    std::cout << "numRoomsWithDist1000OrMore: " << numRoomsWithDist1000OrMore << std::endl;
    return 0;
}
