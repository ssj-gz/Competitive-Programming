...
int main()
{
    ...
    auto applyInstruction = [&instructionPointerRegister]( const vector<int>& instruction, const vector<int>& inputRegistersOrig, int& instructionPointer)
    {
        vector<int> inputRegisters = inputRegistersOrig;
    ...
    while (true)
    {
        ...
        //std::cout << "instructionPointer is now: " << instructionPointer << std::endl;
        numIterations++;
        if (numIterations % 10'000 == 0)
    ...
    std::cout << "result: " << registers[0] << std::endl;
