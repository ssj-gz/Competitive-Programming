            ...
            case Query::IsRangeFormatted:
                {
                    ...
                    if (queryAnswer == -1)
                    {
                        ...
                        cout << "The position $p$ is not part of a formatted range; $A = 3141592$." << endl;
                    }
                    else
                        cout << "The position $p$ is part of a formatted range and the number of ``X``s is this range is " << queryAnswer << "; so $A = " << queryAnswer << "$." << endl;
